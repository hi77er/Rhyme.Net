...
public abstract class BaseEfRepoTestFixture<TDomainAggregate> where TDomainAggregate : class, IAggregateRoot
{
  ...
  protected EfRepository<TDomainAggregate> GetRepository()
  {
